...
CONSTRAINT teamManager_leagueCommissioner FOREIGN KEY (league_commissioner_id)
...
league_commissioner_id INT NOT NULL,
CONSTRAINT messageBoard_leagueCommissioner FOREIGN KEY (league_commissioner_id)
REFERENCES League_Commissioner(league_commissioner_id)
ON UPDATE CASCADE
ON DELETE CASCADE
);
...
,('Cavaliers',6,'Western',33)
,('Pelicans',26,'Eastern',34)
,('Magic',13,'Western',32)
,('Hornets',30,'Western',35)
,('Wizards',13,'Eastern',19);
# select * from Team;
...
INSERT INTO Team_Manager(first_name,last_name,tenure,salary,team_id,league_commissioner_id,team_manager_id) VALUES
 ('Benn','Matusson',1,4121900,29,1,1)
...
,('Sandor','Gregoraci',688931.0,8,240,240,'pf',1932,340,65,32,450,45,65)
,('Sharla','Maeer',3994546.0,5,241,241,'pf',1401,250,33,33,450,82,33)
...
,('Tansy','Capelow',3,'sh',18)
,('Sarge','Laville',4,'sh',21)
,('Allie','Cavnor',1,'pf',16)
,('Zena','Juster',6,'pf',27)
